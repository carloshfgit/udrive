...
export function ChatConversationCard({ conversation, onPress }: ChatConversationCardProps) {
    ...
    return (
        <TouchableOpacity
            ...
            className="flex-row items-center p-4 bg-white border-b border-neutral-100 active:bg-neutral-50"
        >
            <Avatar
            ...
            <View className="flex-1 ml-3">
                <View className="flex-row justify-between items-center mb-1">
                    <Text className="text-neutral-900 font-semibold text-base" numberOfLines={1}>
