...
- A hora de início da aula deve ter passado (`lesson_start_datetime < now`).
- O aluno clica no botão **"Relatar Problema"** na tela de detalhes da aula.
- A tela de disputa abre com um aviso amigável: Está tendo problemas? Acumule evidências, fotos, prints, vídeos e solicite contato com o suporte para resolver a situação.

### Fluxo no Mobile:

1. **Botão de Ação:** Exibido apenas em aulas confirmadas cujo o horário de início já passou.
...
6. **Aviso:** A tela de detalhes da aula exibe um aviso de que o agendamento foi para disputa e que o suporte entrará em contato em até 24 horas úteis.
